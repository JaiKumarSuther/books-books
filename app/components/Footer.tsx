            ...
            <div className="mx-auto grid max-w-[1600px] gap-8 px-4 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                        <div className="rounded-full p-0 text-secondary">
                    ...
                    <div className="space-y-2 mt-4">
                        ...
                        <p className="text-sm text-gray-600 hover:text-secondary cursor-pointer transition-colors">
                    ...
                    <div className="flex items-center gap-4 pt-2">
                        {[Twitter, Instagram, Facebook, Linkedin].map((Icon, idx) => (
                            <button key={idx} className="text-gray-900 transition-colors hover:text-secondary">
