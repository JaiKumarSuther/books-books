...
export const booksData: Product[] = [
    // Pre-School & Primary
    { id: "b1", name: "Oxford Modern English - Primer A", price: 850, category: "Pre-School", image: "/placeholder", description: "Standard English curriculum book for beginners.", rating: 5 },
    { id: "b2", name: "New Countdown Mathematics - Level 1", price: 950, category: "Primary", image: "/placeholder", description: "Oxford simplified math for grade 1.", rating: 4.5 },
    { id: "b3", name: "Urdu Khushkhati - Class 2", price: 350, category: "Primary", image: "/placeholder", description: "Improve handwriting with traced exercises.", rating: 4 },
    { id: "b4", name: "Science Factor - Level 3", price: 1050, category: "Primary", image: "/placeholder", description: "Engaging science concepts for young minds.", rating: 5 },
    { id: "b5", name: "Oxford Social Studies - Class 5", price: 980, category: "Primary", image: "/placeholder", description: "History and geography basics.", rating: 4.5 },
...
export const uniformsData: Product[] = [
    // Boys
    { id: "u1", name: "White School Shirt - Boys (Size 12)", price: 850, category: "Boys", image: "/placeholder", description: "Cotton mix, crisp white shirt.", rating: 4.5 },
    { id: "u2", name: "Grey Trousers - Boys (Waist 28)", price: 1200, category: "Boys", image: "/placeholder", description: "Durable tropical fabric.", rating: 4 },
    { id: "u3", name: "School Tie - Navy Blue", price: 250, category: "Accessories", image: "/placeholder", description: "Standard striped school tie.", rating: 4 },
    { id: "u4", name: "Black School Belt", price: 350, category: "Accessories", image: "/placeholder", description: "Leather finish belt with steel buckle.", rating: 4 },
    ...
    // Shoes
    { id: "u9", name: "Bata Black Shoes - Size 4", price: 2500, category: "Shoes", image: "/placeholder", description: "Durable black school shoes.", rating: 5 },
    { id: "u10", name: "Service White Joggers - Size 5", price: 3000, category: "Shoes", image: "/placeholder", description: "For PT and sports day.", rating: 4.5 },
...
export const stationeryData: Product[] = [
    // Writing
    { id: "s1", name: "Piano Point 0.5mm (Blue) - Box", price: 150, category: "Writing", image: "/placeholder", description: "Pack of 10 smooth ballpoints.", rating: 5 },
    { id: "s2", name: "Dollar Ink Pen 717", price: 80, category: "Writing", image: "/placeholder", description: "Classic fountain pen for students.", rating: 4.5 },
    { id: "s3", name: "Goldfish Pencils (Pack of 12)", price: 200, category: "Writing", image: "/placeholder", description: "High quality HB pencils.", rating: 5 },
    { id: "s4", name: "Whitemate Board Markers (4 Colors)", price: 350, category: "Writing", image: "/placeholder", description: "Erasable ink markers.", rating: 4 },
    ...
    // Geometry
    { id: "s13", name: "Dux Geometry Box", price: 450, category: "Geometry", image: "/placeholder", description: "Standard metal box with instruments.", rating: 4 },
    { id: "s14", name: "Casio fx-991ES Plus", price: 4500, category: "Geometry", image: "/placeholder", description: "Scientific calculator for engineering.", rating: 5 },
];

export const bagsData: Product[] = [
    // Backpacks
    { id: "bg1", name: "Spiderman 3D Bag", price: 2500, category: "Backpack", image: "/placeholder", description: "Hard shell 3D character bag for kids.", rating: 5 },
    { id: "bg2", name: "Frozen Theme Bag", price: 2500, category: "Backpack", image: "/placeholder", description: "Pink/Purple Frozen theme school bag.", rating: 5 },
    { id: "bg3", name: "Senior Hiking Bag (Black)", price: 3500, category: "Backpack", image: "/placeholder", description: "Large capacity multi-pocket bag.", rating: 4.5 },
    { id: "bg4", name: "Laptop Bag - Waterproof", price: 2800, category: "Backpack", image: "/placeholder", description: "Padded sleeve for 15 inch laptops.", rating: 4.5 },
    ...
    // Lunch & Water
    { id: "bg7", name: "Steel Water Bottle 750ml", price: 1200, category: "Essentials", image: "/placeholder", description: "Vacuum insulated hot/cold bottle.", rating: 4.5 },
    { id: "bg8", name: "Insulated Lunch Box", price: 850, category: "Essentials", image: "/placeholder", description: "Keep food warm for 4-6 hours.", rating: 4 },
    { id: "bg9", name: "Plastic Water Bottle", price: 450, category: "Essentials", image: "/placeholder", description: "BPA free durable plastic.", rating: 4 },
];
