        ...
        <div className="py-12 max-w-[1280px] mx-auto px-4 min-h-screen">
            ...
            >
                ...
                <div className="relative z-20 w-full md:w-2/3 flex flex-col justify-center">
                    <span className="bg-purple-50 text-purple-600 px-4 py-1.5 rounded-lg text-xs font-bold uppercase mb-4 inline-block tracking-wider w-fit">
                        Category
                    </span>
                ...
                <div className="absolute right-0 top-0 h-full w-1/3 hidden md:flex items-center justify-center bg-purple-50/30">
                    <PenTool size={140} className="text-purple-200/50" strokeWidth={1.5} />
                </div>
            </motion.div>
